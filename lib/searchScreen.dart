...
import 'package:patienaid/myDivider.dart';
import 'package:patienaid/placesPredictions.dart';
...
class _SearchScreenState extends State<SearchScreen> {
                  ...
                  children: [
                    ...
                    Stack(
                      children: [
                        ...
                        Center(
                          child: Text("Set Drop Off", style: TextStyle(fontSize: 20.0),),
                        ),
                      ],
                    ),
  ...
  void findPlace(String placeName) async{
    if(placeName.length > 1){
      var autoCompleteUrl = Uri.parse("https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$placeName&key=$map&sessiontoken=1234567890&components=country:bd");
...
class PredictionTile extends StatelessWidget {
  ...
  void getPlaceAddressDetails(String placeId, context)async{
    ...
    String placeDetailsUrl = "https://maps.googleapis.com/maps/api/place/details/json?place_id=$placeId&key=$map";
    ...
    if(res["status"] == "OK"){
      ...
      address.placeName = res["results"]["name"];
